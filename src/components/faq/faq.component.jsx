           ...
           </div>
         {
          ...
          <div className='listcontainer'>
           <ul className='list'>Free Standard Shipping to the following countries:</ul>
               ...
               <ul className='list'>Europe: Austria, Belgium, Croatia, Czech Republic, Denmark, Estonia, Finland, France, Germany, Gibraltar, Greece, Hungary, Ireland, Italy, Latvia, Lithuania, Luxembourg, Malta, Netherlands, Poland, Portugal, Serbia, Slovakia, Slovenia, Spain, Sweden, Switzerland, United Kingdom.</ul>
               ...
               <ul className='list'>More countries: Australia, Brazil, New Zealand, Russia, Turkey. Didn’t see your country? Don’t worry. Please email support@s0h0quest.co for more information.</ul>
           </div>
           :
           null
         }
           ...
           <div className='container'>
               <div className='icon'>
                  ...
                  {/* <KeyboardArrowDownIcon onClick={isToggle}/> */}
               </div>
               <div className='border'></div>
           </div>
           {
